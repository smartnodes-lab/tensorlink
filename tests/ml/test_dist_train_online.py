...
if __name__ == "__main__":
    # Launch Nodes
    user = UserNode(upnp=False, debug=True, off_chain_test=False, local_test=False, print_level=logging.DEBUG)
    time.sleep(0.5)
    worker = WorkerNode(upnp=False, debug=True, off_chain_test=False, local_test=False, print_level=logging.DEBUG)
    time.sleep(0.5)
    validator = ValidatorNode(upnp=False, debug=True, off_chain_test=False, local_test=False, print_level=logging.DEBUG)
    time.sleep(0.5)
