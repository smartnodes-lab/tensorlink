...
node1 = Validator(Queue(), Queue(), upnp=True, off_chain_test=True, debug=True)
user = User(Queue(), Queue(), upnp=True, off_chain_test=True, debug=True)
worker = Worker(Queue(), Queue(), upnp=True, off_chain_test=True, debug=True)
