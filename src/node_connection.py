...
class NodeConnection(threading.Thread):
    """Used by the class Node and represent the TCP/IP socket connection with another node.
    ...
    def decompress(self, compressed):
        ...
        self.main_node.debug_print(self.id + ":decompress:result: " + str(decompressed))
